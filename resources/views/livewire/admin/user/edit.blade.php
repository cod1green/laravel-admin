@section('title', trans('project.user.edit'))
...
<div>
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class='fa fa-user-edit'></i> @lang('project.user.edit')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i class='fa fa-user-edit'></i> @lang('project.user.edit')
                        </li>
                    </ol>
                </div>
            </div>
