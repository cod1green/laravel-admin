...
<body class="front-page page-loader-2">
    ...
    <div class="page-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            ...
                                                                            <ul class="menu">
                                                                                ...
                                                                                <li class="active"><a href="index-hotel.html"><i class="fa fa-bed pr-2"></i>Hotel <span class="badge">v1.1</span></a></li>
        ...
        <!-- banner start -->
        <!-- ================ -->
        <div class="banner banner-big-height dark-translucent-bg padding-bottom-clear" style="background-image:url('{{ asset('vendor/frontend/template/images/hotel-banner.jpg') }}');background-position: 50% 32%;">
            <div class="container">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3">
                        <div class="image-box style-2 mb-20">
                            <div class="overlay-container overlay-visible">
                                <img src="{{ asset('vendor/frontend/template/images/hotel-service-1.jpg') }}" alt="">
                    ...
                    <div class="col-md-3">
                        <div class="image-box style-2 mb-20">
                            <div class="overlay-container overlay-visible">
                                <img src="{{ asset('vendor/frontend/template/images/hotel-service-2.jpg') }}" alt="">
                                <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                                <div class="overlay-bottom">
                                    <div class="text">
                    ...
                    <div class="col-md-3">
                        <div class="image-box style-2 mb-20">
                            <div class="overlay-container overlay-visible">
                                <img src="{{ asset('vendor/frontend/template/images/hotel-service-3.jpg') }}" alt="">
                                <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                                <div class="overlay-bottom">
                                    <div class="text">
                    ...
                    <div class="col-md-3">
                        <div class="image-box style-2 mb-20">
                            <div class="overlay-container overlay-visible">
                                <img src="{{ asset('vendor/frontend/template/images/hotel-service-4.jpg') }}" alt="">
                                <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                                <div class="overlay-bottom">
                                    <div class="text">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="testimonial text-center">
                            <div class="testimonial-image">
                                <img src="{{ asset('vendor/frontend/template/images/testimonial-3.jpg') }}" alt="Famous Person" title="Famous Person" class="rounded-circle">
                            </div>
                            <h3>Amazing!</h3>
                            <div class="separator"></div>
                            <div class="testimonial-body">
                        ...
                        <div class="call-to-action pv-40 ph-20 text-center" style="background-color: rgba(0,0,0,0.3);">
                            ...
                            <form class="form-inline margin-clear d-flex justify-content-center">
                                <div class="form-group has-feedback">
                                    ...
                                    <input type="email" class="form-control form-control-lg" id="subscribe" placeholder="Enter email" required="">
                                    <i class="fa fa-envelope form-control-feedback"></i>
                                </div>
                                <button type="submit" class="btn btn-lg btn-gray-transparent btn-animated ml-md-3 mt-sm-3 mt-md-0">Submit <i class="fa fa-send"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row grid-space-0">
                    <div class="col-lg-6">
                        <div class="image-box text-center">
                            <div class="overlay-container">
                                <img src="{{ asset('vendor/frontend/template/images/hotel-image-1.jpg') }}" alt="">
                    ...
                    <div class="col-lg-6">
                        <div class="image-box text-center">
                            <div class="overlay-container">
                                <img src="{{ asset('vendor/frontend/template/images/hotel-image-2.jpg') }}" alt="">
                                <div class="overlay-top">
                                    <div class="text">
                    ...
                    <div class="col-lg-6">
                        <div class="image-box text-center">
                            <div class="overlay-container">
                                <img src="{{ asset('vendor/frontend/template/images/hotel-image-3.jpg') }}" alt="">
                                <div class="overlay-top">
                                    <div class="text">
                    ...
                    <div class="col-lg-6">
                        <div class="image-box text-center">
                            <div class="overlay-container">
                                <img src="{{ asset('vendor/frontend/template/images/hotel-image-4.jpg') }}" alt="">
                                <div class="overlay-top">
                                    <div class="text">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="footer-content">
                                    <div class="logo-footer"><img id="logo-footer" src="{{ asset('vendor/frontend/template/images/logo_gold.png') }}" alt=""></div>
                                    <div class="row">
                                        <div class="col-lg-6">
