...
<body class="front-page ">
    ...
    <div class="page-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 col-md-5">
                            ...
                            <ul class="list-inline text-muted hidden-sm-down">
                                <li class="list-inline-item"><strong class="pl-1">Call Us:</strong> <a href="#">+00 123 123 123</a></li>
                            </ul>
                        ...
                        <div class="col-12 col-md-7">
                            ...
                            <div id="header-top-second"  class="clearfix text-right">
                                <ul class="list-inline">
                                    <li class="list-inline-item hidden-md-up"><strong class="pl-1">Call Us:</strong> <a href="#">+00 123 123 123</a></li>
                                    <li class="list-inline-item"><i class="fa fa-search pr-1"></i> <a class="link-dark" href="#">Track</a></li>
                                    <li class="list-inline-item"><i class="fa fa-user pl-2 pr-1"></i> <a class="link-dark" href="#">Login</a></li>
                                    <li class="list-inline-item"><i class="fa fa-support pl-2 pr-1"></i> <a class="link-dark" href="#">Support</a></li>
                                </ul>
                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            ...
                                                                            <ul class="menu">
                                                                                ...
                                                                                <li class="active"><a href="index-logistics.html"><i class="fa fa-truck pr-2"></i>Logistics <span class="badge">v1.2</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                    </div>
                                                                </div>
                ...
                <div class="slider-revolution-5-container">
                    <div id="slider-banner-fullwidth-big-height" class="slider-banner-fullwidth-big-height rev_slider" data-version="5.0">
                        <ul class="slides">
                            <!-- slide 1 start -->
                            <!-- ================ -->
                            <li data-transition="crossfade" data-slotamount="default" data-masterspeed="default" data-title="Next Generation Template">

                                <!-- main image -->
                                <img src="{{ asset('vendor/frontend/template/images/logistics-slide-1.jpg') }}" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover"  class="rev-slidebg">
                            ...
                            <li data-transition="crossfade" data-slotamount="default" data-masterspeed="default" data-title="Premium Bootstrap Template">
                                ...
                                <!-- main image -->
                                <img src="{{ asset('vendor/frontend/template/images/logistics-slide-2.jpg') }}" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                ...
                <div class="row">
                    <div class="col-lg-4 padding-bottom-clear pv-30">
                        <div class="hc-item-box-2">
                            <span class="icon without-bg"><i class="text-default fa fa-truck"></i></span>
                            <div class="body">
                                ...
                                <p><a href="page-services.html">Read More<i class="pl-1 fa fa-angle-double-right"></i></a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 padding-bottom-clear pv-30 default-translucent-bg">
                        <div class="hc-item-box-2">
                            <span class="icon without-bg"><i class="fa fa-plane"></i></span>
                            <div class="body">
                                <h4 class="title">International Shipping</h4>
                                <p>Iure sequi unde hic. Sapiente quaerat sequi inventore veritatis cumque lorem ipsum dolor sit amet, consectetur.</p>
                                <p><a class="link-light" href="page-services.html">Read More<i class="pl-1 fa fa-angle-double-right"></i></a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 padding-bottom-clear pv-30">
                        <div class="hc-item-box-2">
                            <span class="icon without-bg"><i class="text-default fa fa-suitcase"></i></span>
                            <div class="body">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="main col-12">
                        ...
                        <p class="large text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br> Commodi est velit voluptates eaque illo culpa.</p>
                        <br>
                        <!-- page-title end -->
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="image-box style-2 mb-20">
                                    <div class="overlay-container overlay-visible">
                                        <img src="{{ asset('vendor/frontend/template/images/logistics-service-1.jpg') }}" alt="">
                                        <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                                        <div class="overlay-bottom">
                                            <div class="text">
                                                <p class="lead margin-clear mobile-visible">Service One</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="body text-center padding-horizontal-clear">
                                        ...
                                        <p><a class="btn btn-default" href="page-services.html">Read More</a></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="image-box style-2 mb-20">
                                    <div class="overlay-container overlay-visible">
                                        <img src="{{ asset('vendor/frontend/template/images/logistics-service-2.jpg') }}" alt="">
                                        <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                                        <div class="overlay-bottom">
                                            <div class="text">
                                                <p class="lead margin-clear mobile-visible">Service Two</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="body text-center padding-horizontal-clear">
                            ...
                            <div class="col-md-6">
                                <div class="image-box style-2 mb-20">
                                    <div class="overlay-container overlay-visible">
                                        <img src="{{ asset('vendor/frontend/template/images/logistics-service-3.jpg') }}" alt="">
                                        <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                                        <div class="overlay-bottom">
                                            <div class="text">
                                                <p class="lead margin-clear mobile-visible">Service Three</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="body text-center padding-horizontal-clear">
                            ...
                            <div class="col-md-6">
                                <div class="image-box style-2 mb-20">
                                    <div class="overlay-container overlay-visible">
                                        <img src="{{ asset('vendor/frontend/template/images/logistics-service-4.jpg') }}" alt="">
                                        <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                                        <div class="overlay-bottom">
                                            <div class="text">
                                                <p class="lead margin-clear mobile-visible">Service Four</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="body text-center padding-horizontal-clear">
        ...
        <!-- section start -->
        <!-- ================ -->
        <section class="section fixed-bg dark-translucent-bg" style="background-image: url('{{ asset('vendor/frontend/template/images/logistics-section-1.jpg') }}'); background-position: 50% 50%;">
            <div class="container">
                <div class="row justify-content-lg-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="mt-4">Our <strong>Partners</strong></h2>
                        <div class="separator"></div>
        ...
        <!-- section start -->
        <!-- ================ -->
        <section class="clearfix light-gray-bg pv-40">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="footer-content">
                                    ...
                                    <h4 class="title"><i class="fa fa-wechat pr-10"></i> Consectetur adipisicing</h4>
                                    <nav class="mb-20">
                                        <ul class="nav flex-column list-style-icons">
                            ...
                            <div class="col-lg-3">
                                <div class="footer-content">
                                    <h4 class="title"><i class="fa fa-search pr-10"></i> Resources</h4>
                                    <nav class="mb-20">
                                        <ul class="nav flex-column list-style-icons">
                            ...
                            <div class="col-lg-3">
                                <div class="footer-content">
                                    <h4 class="title"><i class="fa fa-file-text-o pr-10"></i> Customers</h4>
                                    <nav class="mb-20">
                                        <ul class="nav flex-column list-style-icons">
