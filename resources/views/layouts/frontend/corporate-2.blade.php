...
<body class="front-page ">
    ...
    <div class="page-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                            ...
                                                                            <ul class="menu">
                                                                                ...
                                                                                <li class="active"><a href="index-corporate-2.html"><i class="fa fa-suitcase pr-2"></i>Corporate 2</a></li>
                ...
                <div class="slider-revolution-5-container">
                    <div id="slider-banner-fullwidth-big-height" class="slider-banner-fullwidth-big-height rev_slider" data-version="5.0">
                        <ul class="slides">
                            <!-- slide 1 start -->
                            <!-- ================ -->
                            <li data-transition="slidehorizontal" data-slotamount="default" data-masterspeed="default" data-title="Next Generation Template">

                                <!-- main image -->
                                <img src="{{ asset('vendor/frontend/template/images/corporate-2-slider-slide-1.jpg') }}" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover"  class="rev-slidebg">
                                ...
                                <div class="tp-caption medium_white"
                                     ...
                                     data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;"
                                     data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                     data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"><span class="icon default-bg circle small hidden-sm-down"><i class="fa fa-laptop"></i></span> 100% Responsive
                                </div>
                                ...
                                <div class="tp-caption medium_white"
                                     ...
                                     data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;"
                                     data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                     data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"><span class="icon default-bg circle small hidden-sm-down"><i class="fa fa-check"></i></span> Bootstrap Based
                                </div>
                                ...
                                <div class="tp-caption medium_white"
                                     ...
                                     data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;"
                                     data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                     data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"><span class="icon default-bg circle small hidden-sm-down"><i class="fa fa-gift"></i></span> Packed Full of Features
                                </div>
                                ...
                                <div class="tp-caption medium_white"
                                     ...
                                     data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;"
                                     data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                     data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"><span class="icon default-bg circle small hidden-sm-down"><i class="fa fa-hourglass-half"></i></span> Very Elegant Design
                                </div>
                            ...
                            <!-- slide 2 start -->
                            <!-- ================ -->
                            <li data-transition="slidehorizontal" data-slotamount="default" data-masterspeed="default" data-title="Premium Bootstrap Template">

                                <!-- main image -->
                                <img src="{{ asset('vendor/frontend/template/images/corporate-2-slider-slide-2.jpg') }}" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                                ...
                                <div class="tp-caption large_white"
                                     ...
                                     data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;"
                                     data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                     data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;">Premium HTML5 Bootstrap Theme
                                </div>
                                ...
                                <div class="tp-caption medium_white"
                                     ...
                                     data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;"
                                     data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                     data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"><span class="icon default-bg circle small hidden-sm-down"><i class="fa fa-laptop"></i></span> W3C Validated
                                </div>
                                ...
                                <div class="tp-caption medium_white"
                                     ...
                                     data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;"
                                     data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                     data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"><span class="icon default-bg circle small hidden-sm-down"><i class="fa fa-check"></i></span> Unt loremcu dolor
                                </div>
                                ...
                                <div class="tp-caption medium_white"
                                     ...
                                     data-transform_out="y:[100%];s:1000;e:Power2.easeInOut;"
                                     data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                     data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;"><span class="icon default-bg circle small hidden-sm-down"><i class="fa fa-gift"></i></span> Crossbrowser Compatible
                                </div>
        ...
        <section class="full-width-section pv-40 light-gray-bg border-clear">
            <div class="clearfix">
                <img class="pull-right hc-element-invisible" data-animation-effect="slideInUp" data-effect-delay="100" src="{{ asset('vendor/frontend/template/images/section-image-1.png') }}" alt="">
            </div>
            <div class="full-text-container light-gray-bg border-clear">
                <h2 class="mt-4">Core <strong>Features</strong></h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non tempore mollitia sed, temporibus, quaerat recusandae!</p>
                <br class="hidden-md-down">
                <div class="hc-item-box-2 margin-clear">
                    <span class="icon without-bg"><i class="text-default fa fa-snowflake-o"></i></span>
                    <div class="body">
                        <h4 class="mt-3">Lorem dolor sit</h4>
                ...
                <div class="hc-item-box-2 margin-clear">
                    ...
                    <div class="body">
                        <h4 class="mt-3">Unt in culpa qui</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod ut labore et dolore magna aliqua.</p>
                        <div class="separator-2 visible-lg"></div>
                    </div>
                </div>
        ...
        <section class="full-width-section pv-40 light-gray-bg border-clear">
            <div class="full-text-container text-right left light-gray-bg border-clear">
                <h2 class="mt-4">Simply <strong>Amazing</strong></h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non tempore mollitia sed, temporibus, quaerat recusandae!</p>
                <br class="hidden-md-down">
                <div class="hc-item-box-2 right margin-clear">
                    <span class="icon without-bg"><i class="text-default fa fa-snowflake-o"></i></span>
                    <div class="body">
                        <h4 class="mt-3">Lorem dolor sit</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod ut labore et dolore magna aliqua.</p>
            ...
            <div class="clearfix">
                <img class="hc-element-invisible" data-animation-effect="slideInDown" data-effect-delay="100" src="{{ asset('vendor/frontend/template/images/section-image-2.png') }}" alt="">
            </div>
        </section>
        <!-- section end -->
        ...
        <section class="pv-40 clearfix">
            <div class="container">
                <h2 class="mt-4 text-center"><strong>Sign Up</strong> Now</h2>
                    ...
                    <div class="row grid-space-10">
                        <div class="col-md-3">
                            ...
                            <div class="plan hc-shadow light-gray-bg bordered">
                                ...
                                <ul class="hc-shadow light-gray-bg">
                                    ...
                                    <li>Pricing table item</li>
                                    <li>Pricing table item</li>
                                    <li><a href="#" class="btn btn-dark btn-animated radius-50">Subscribe <i class="fa fa-user"></i></a></li>
                                </ul>
                            </div>
                            <!-- pricing table end -->
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="plan hc-shadow light-gray-bg bordered">
                                ...
                                <ul class="hc-shadow light-gray-bg">
                                    ...
                                    <li>Pricing table item</li>
                                    <li>Pricing table item</li>
                                    <li><a href="#" class="btn btn-dark btn-animated radius-50">Add to cart <i class="fa fa-shopping-cart"></i></a></li>
                                </ul>
                            </div>
                            <!-- pricing table end -->
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="plan hc-shadow light-gray-bg bordered best-value">
                                ...
                                <ul class="hc-shadow light-gray-bg">
                                    ...
                                    <li>Pricing table item</li>
                                    <li>Pricing table item</li>
                                    <li><a href="#" class="btn btn-default btn-animated radius-50">Add to cart <i class="fa fa-shopping-cart"></i></a></li>
                                </ul>
                            </div>
                            <!-- pricing table end -->
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="call-to-action text-center">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <p class="mt-3"><a href="#" class="btn btn-animated radius-50 btn-lg btn-gray-transparent">Purchase<i class="fa fa-cart-arrow-down pl-20"></i></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
