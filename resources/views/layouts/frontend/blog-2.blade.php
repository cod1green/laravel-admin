                    ...
                    <div class="slider-revolution-5-container">
                        <div id="slider-banner-fullwidth-big-height" class="slider-banner-fullwidth-big-height rev_slider" data-version="5.0">
                            <ul class="slides">
                                ...
                                <li data-transition="crossfade" data-slotamount="default" data-masterspeed="default" data-title="Next Generation Template">
                                    ...
                                    <!-- main image -->
                                    <img src="{{ asset('vendor/frontend/template/images/blog-2-slide-1.jpg') }}" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover"  class="rev-slidebg">
                                    ...
                                    <div class="tp-caption large_white"
                                        ...
                                        <a href="#">Next Generation Template</a>
                                    </div>
                        ...
                        <span class="post-date">
                          ...
                          <span class="month">Jan 2017 | </span>
                                    ...
                                    <div class="tp-caption white small_white"
                                         ...
                                         data-mask_in="x:0px;y:0px;s:inherit;e:inherit;"
                                         data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi commodi reiciendis recusandae sapiente at omnis nemo fugit...</p>
                                    </div>
                                    ...
                                    <div class="tp-caption small_white"
                                         ...
                                         data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                         data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;">
                                        <a href="#" class="btn-md-link padding-hor-clear">Read More <i class="fa fa-arrow-right"></i></a>
                                    </div>
                                ...
                                <li data-transition="crossfade" data-slotamount="default" data-masterspeed="default" data-title="Premium Bootstrap Template">
                                    ...
                                    <!-- main image -->
                                    <img src="{{ asset('vendor/frontend/template/images/blog-2-slide-2.jpg') }}" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                                    ...
                                    <div class="tp-caption large_white"
                                         ...
                                         data-mask_in="x:0px;y:[100%];s:inherit;e:inherit;"
                                         data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;">
                                        <a href="#">Premium Bootstrap Template</a>
                                    </div>
                        ...
                        <span class="post-date">
                          ...
                          <span class="month">Dec 2017 | </span>
                                            ...
                                            <span class="comments"><i class="fa fa-comments-o pl-1 pr-1"></i> <a href="#">55 comments</a></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tp-caption white small_white"
                                         ...
                                         data-mask_in="x:0px;y:0px;s:inherit;e:inherit;"
                                         data-mask_out="x:inherit;y:inherit;s:inherit;e:inherit;">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet ipsam expedita dolorum vero impedit doloremque maiores officiis...</p>
                                    </div>
                    ...
                    <div class="main col-12">
                        ...
                        <span class="post-date">
                          ...
                          <span class="month">May 2017</span>
                            ...
                            <div class="masonry-grid-item col-md-6 col-lg-4">
                                <!-- blogpost start -->
                                <article class="blogpost hc-shadow-2 light-gray-bg bordered hc-element-invisible" data-animation-effect="fadeInUpSmall" data-effect-delay="100">
                                    <header>
                    ...
                    <div class="col-lg-8">
                        ...
                        <article class="blogpost">
                            <div class="row grid-space-10">
                                <div class="col-lg-6">
                                    <div id="carousel-blog-post-2" class="carousel slide" data-ride="carousel">
                                        <!-- Indicators -->
                                        <ol class="carousel-indicators bottom margin-clear">
                                            <li data-target="#carousel-blog-post-2" data-slide-to="0" class="active"></li>
                                            <li data-target="#carousel-blog-post-2" data-slide-to="1"></li>
                                            <li data-target="#carousel-blog-post-2" data-slide-to="2"></li>
                                        </ol>
