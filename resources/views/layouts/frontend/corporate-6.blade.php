    ...
    <div class="page-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                            ...
                                                                            <ul class="menu">
                                                                                ...
                                                                                <li class="active"><a href="index-corporate-6.html"><i class="fa fa-suitcase pr-2"></i>Corporate 6<span class="badge">v2.1</span></a></li>
                                                                            </ul>
                                                                        </div>
                                                                        <div class="col-lg-3">
                                                                            <div class="divider"></div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="fullscreen-slide">
                            <div class="background-image" style="background-image:url('{{ asset('vendor/frontend/template/images/slider-fullscreen-slide-1.jpg') }}');"></div>
                            <div class="background-image-overlay"></div>
                            <div class="container">
                                <div class="hc-slideshow-caption hc-slideshow-caption--large p-3 text-center w-100">
                                    <h1 class="text-white text-capitalize animated fadeInDown hc-animation-delay-1000">The Project</h1>
                                    <p class="animated fadeInUp hc-animation-delay-1250">Lorem ipsum dolor sit amet, consectetur adipisicing elit. <br class="d-none d-sm-inline"> Possimus dolore odio alias nisi minus ad consequatur <br class="d-none d-sm-inline"> quod exercitationem voluptate int.</p>
                    ...
                    <div class="carousel-item">
                        <div class="fullscreen-slide">
                            <div class="background-image" style="background-image:url('{{ asset('vendor/frontend/template/images/slider-fullscreen-slide-2.jpg') }}');"></div>
                            <div class="background-image-overlay"></div>
                            <div class="container">
                                <div class="hc-slideshow-caption hc-slideshow-caption--large p-3 text-center w-100">
                                    <h1 class="text-white text-capitalize animated fadeInDown hc-animation-delay-1000">Slide Title</h1>
                                    <p class="animated fadeInUp hc-animation-delay-1250">Fugit tenetur ullam sequi, explicabo doloribus id numquam <br class="d-none d-sm-inline"> repudiandae velit doloremque eveniet a, qui veritatis <br class="d-none d-sm-inline"> int quod exercitationem voluptate.</p>
                    ...
                    <div class="carousel-item">
                        <div class="fullscreen-slide">
                            <div class="background-image" style="background-image:url('{{ asset('vendor/frontend/template/images/slider-fullscreen2-slide-1.jpg') }}');"></div>
                            <div class="background-image-overlay"></div>
                            <div class="container">
                                <div class="hc-slideshow-caption hc-slideshow-caption--large p-3 text-center w-100">
                                    <h1 class="text-white text-capitalize animated fadeInDown hc-animation-delay-1000">Your Slide Title</h1>
                                    <p class="animated fadeInUp hc-animation-delay-1250">Totam soluta doloremque aliquid labore quod ut, assumenda <br class="d-none d-sm-inline"> consectetur error maiores eligendi sint velit minima <br class="d-none d-sm-inline"> voluptate quod exercitationem int.</p>
                    ...
                    <div class="col-12">
                        <div class="call-to-action text-center">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <br>
                                    <p><a href="#" class="btn btn-lg btn-outline-light btn-animated">Learn More<i class="fa fa-arrow-right pl-20"></i></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="overlay-container overlay-visible">
                                    ...
                                    <a href="images/page-about-2.jpg" class="popup-img overlay-link" title="image title"><i class="fa fa-plus"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="light-gray-bg pv-40 section mt-20">
                <div class="container">
                    ...
                    <div class="row grid-space-10">
                        <div class="col-md-4">
                            <div class="team-member image-box style-2 bordered hc-shadow-2 text-center">
                                ...
                                <div class="body">
                                    ...
                                    <a href="#" class="margin-clear btn btn-md-link link-dark"><i class="pr-10 fa fa-envelope-o"></i>Contact</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <ul class="list-icons">
                            ...
                            <li class="hc-element-invisible" data-animation-effect="fadeInUpSmall" data-effect-delay="150"><i class="fa fa-check-square-o"></i> Ipsum quas repellendus of incidunt</li>
                            <li class="hc-element-invisible" data-animation-effect="fadeInUpSmall" data-effect-delay="200"><i class="fa fa-check-square-o"></i> Unt loremcu</li>
                            <li class="hc-element-invisible" data-animation-effect="fadeInUpSmall" data-effect-delay="250"><i class="fa fa-check-square-o"></i> 190+ HTML files</li>
                        </ul>
        ...
        <section class="pv-30 light-gray-bg padding-bottom-clear">
            ...
            <div class="space-bottom">
                ...
                <div class="container">
                    <h3 class="text-center mt-4">Some <strong>Info</strong> about <span class="logo-font"><span class="text-muted">Τhe</span> <span class="text-default">Project</span></span></h3>
                    <div class="separator mb-20"></div>
                    <div class="row">
                        <div class="col-md-3 col-xs-6 text-center">
                            <div class="hc-item-box hc-shadow-narrow bordered pv-20 light-gray-bg hc-element-invisible" data-animation-effect="fadeIn" data-effect-delay="300">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="footer-content">
                                    ...
                                    <ul class="social-links large circle text-center mt-5 mb-3" style="opacity: 0.2;">
                                    ...
                                    <p class="text-center text-muted">Copyright © 2019. All Rights Reserved</p>
                                </div>
                            </div>
                        </div>
                    </div>
