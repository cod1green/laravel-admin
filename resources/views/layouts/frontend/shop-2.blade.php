    ...
    <div class="page-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            ...
                                                                            <ul class="menu">
                                                                                ...
                                                                                <li class="active"><a href="index-shop-2.html"><i class="fa fa-shopping-basket pr-2"></i>Commerce 2</a></li>
                                        ...
                                        <div class="col-md-6 col-lg-8 col-xl-9">
                                            <div class="body">
                                                ...
                                                <ul class="list-icons">
                                                    ...
                                                    <li><i class="fa fa-check"></i> Totam doloribus mollitia ipsum</li>
                                                </ul>
                                                <div class="elements-list clearfix">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <div class="listing-item">
                                                <div class="overlay-container">
                                                    <img src="{{ asset('vendor/frontend/template/images/product-1.jpg') }}" alt="product 1">
                                                    <span class="badge">30% OFF</span>
                                                    <a href="shop-product.html" class="overlay-link"><i class="fa fa-link"></i></a>
                                                </div>
                                                <h3 class="mt-3"><a href="shop-product.html">Suscipit consequatur velit</a></h3>
                                                <span class="price"><del>$199.00</del> $150.00</span>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="listing-item">
                                                <div class="overlay-container">
                                                    <img src="{{ asset('vendor/frontend/template/images/product-2.jpg') }}" alt="product 2">
                                                    <span class="badge">20% OFF</span>
                                                    <a href="shop-product.html" class="overlay-link"><i class="fa fa-link"></i></a>
                                                </div>
                                                <h3 class="mt-3"><a href="shop-product.html">Quas inventore modi lorem</a></h3>
                                                <span class="price"><del>$199.00</del> $150.00</span>
                                            </div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="listing-item">
                                                <div class="overlay-container">
                                                    <img src="{{ asset('vendor/frontend/template/images/product-3.jpg') }}" alt="product 3">
                                                    <span class="badge">40% OFF</span>
                                                    <a href="shop-product.html" class="overlay-link"><i class="fa fa-link"></i></a>
                                                </div>
                                                <h3 class="mt-3"><a href="shop-product.html">Consectetur adipisicing elit</a></h3>
                                                <span class="price"><del>$199.00</del> $150.00</span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="block clearfix">
                                ...
                                <div class="media margin-clear">
                                    <div class="d-flex pr-2">
                                        <div class="overlay-container">
                                            <img class="media-object" src="{{ asset('vendor/frontend/template/images/product-5.jpg') }}" alt="blog-thumb">
                                ...
                                <div class="media margin-clear">
                                    <div class="d-flex pr-2">
                                        <div class="overlay-container">
                                            <img class="media-object" src="{{ asset('vendor/frontend/template/images/product-6.jpg') }}" alt="blog-thumb">
                                            <a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                        </div>
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media margin-clear">
                                    <div class="d-flex pr-2">
                                        <div class="overlay-container">
                                            <img class="media-object" src="{{ asset('vendor/frontend/template/images/product-7.jpg') }}" alt="blog-thumb">
                                            <a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                        </div>
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media margin-clear">
                                    <div class="d-flex pr-2">
                                        <div class="overlay-container">
                                            <img class="media-object" src="{{ asset('vendor/frontend/template/images/product-8.jpg') }}" alt="blog-thumb">
                                            <a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                        </div>
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="block clearfix">
                                ...
                                <nav>
                                    <ul class="nav flex-column list-style-icons">
                                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-caret-right pr-10"></i>Diamonds</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-caret-right pr-10"></i>Clothes</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-caret-right pr-10"></i>Shoes</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-caret-right pr-10"></i>Watches</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-caret-right pr-10"></i>Accessories</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-caret-right pr-10"></i>Hats</a></li>
                                        <li class="nav-item"><a class="nav-link" href="#"><i class="fa fa-caret-right pr-10"></i>Perfumes</a></li>
                                    </ul>
                                </nav>
                            </div>
                            <div class="block clearfix">
        ...
        <section class="pv-30 clearfix">
            <div class="container">
                    ...
                    <div class="col-lg-4">
                        <div class="block clearfix">
                            ...
                            <div class="media margin-clear">
                                <div class="d-flex pr-2">
                                    <div class="overlay-container">
                                        <img class="media-object" src="{{ asset('vendor/frontend/template/images/product-1.jpg') }}" alt="blog-thumb">
                                        <a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media margin-clear">
                                <div class="d-flex pr-2">
                                    <div class="overlay-container">
                                        <img class="media-object" src="{{ asset('vendor/frontend/template/images/product-2.jpg') }}" alt="blog-thumb">
                                        <a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media margin-clear">
                                <div class="d-flex pr-2">
                                    <div class="overlay-container">
                                        <img class="media-object" src="{{ asset('vendor/frontend/template/images/product-3.jpg') }}" alt="blog-thumb">
                                        <a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                                <div class="media-body">
                            ...
                            <div class="media margin-clear">
                                <div class="d-flex pr-2">
                                    <div class="overlay-container">
                                        <img class="media-object" src="{{ asset('vendor/frontend/template/images/product-4.jpg') }}" alt="blog-thumb">
                                        <a href="shop-product.html" class="overlay-link small"><i class="fa fa-link"></i></a>
                                    </div>
                                </div>
                                <div class="media-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="mt-4 logo-font">Brands</h3>
                        <div class="separator-2"></div>
