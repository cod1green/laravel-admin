...
<head>
    ...
    <link href="{{ asset('vendor/frontend/template/css/skins/brown.css') }}" rel="stylesheet">
    ...
    <div class="page-wrapper">
                        ...
                        <div class="col-md-auto hidden-md-down pl-3">
                            ...
                            <div class="header-first clearfix">
                                ...
                                <div id="logo" class="logo">
                                    <a href="index.html"><img id="logo_img" src="{{ asset('vendor/frontend/template/images/logo_brown.png') }}" alt="The Project"></a>
                                </div>
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                                        <div class="navbar-brand clearfix hidden-lg-up">
                                            ...
                                            <div id="logo-mobile" class="logo">
                                                <a href="index.html"><img id="logo-img-mobile" src="{{ asset('vendor/frontend/template/images/logo_brown.png') }}" alt="The Project"></a>
                                            </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            ...
                                                                            <ul class="menu">
                                                                                ...
                                                                                <li class="active"><a href="index-portfolio-2.html"><i class="fa fa-camera pr-2"></i>Portfolio 2 <span class="badge">v1.4</span></a></li>
                    ...
                    <div id="slider-banner-fullscreen" class="slider-banner-fullscreen-hero rev_slider" data-version="5.0">
                        <ul class="slides">
                            ...
                            <li data-transition="crossfade" data-slotamount="default" data-masterspeed="default" data-title="Slide Title">
                                ...
                                <!-- main image -->
                                <img src="{{ asset('vendor/frontend/template/images/portfolio-2-slide-1.jpg') }}" alt="slidebg1" data-bgposition="center center" data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="call-to-action light-gray-bg p-20 hc-shadow bordered">
                            <h1 class="text-center">The Project - Multipurpose Template</h1>
                            <div class="separator"></div>
                            <p class="lead text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Deserunt maxime ipsum.</p>
                            <br>
                            <br>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="hc-item-box-2 hc-element-invisible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
                                        ...
                                        <div class="body">
                                            ...
                                            <p>Voluptatem ad provident non repudiandae beatae cupiditate amet reiciendis lorem dolor.</p>
        ...
        <section class="pv-30 padding-bottom-clear light-gray-bg">
            <div class="container">
                <div class="row justify-content-lg-center">
                    <div class="col-lg-10">
                        <h1 class="text-center mt-4 large">Why <strong>Choose</strong> <span class="text-default">the Project</span></h1>
                        <div class="separator"></div>
            ...
            <div class="slider-revolution-5-container">
                <div id="slider-banner-carousel" class="slider-banner-carousel rev_slider" data-version="5.0">
                    <ul class="slides">
                        ...
                        <!-- slide 1 start -->
                        <!-- ================ -->
                        <li data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="300" data-saveperformance="off" data-title="Slide Title">

                            <!-- main image -->
                            <img src="{{ asset('vendor/frontend/template/images/section-image-4.png') }}" alt="slidebg1" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        ...
                        <li data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="300" data-saveperformance="off" data-title="Slide Title">
                            ...
                            <!-- main image -->
                            <img src="{{ asset('vendor/frontend/template/images/section-image-1.png') }}" alt="slidebg1" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        ...
                        <li data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="300" data-saveperformance="off" data-title="Slide Title">
                            ...
                            <!-- main image -->
                            <img src="{{ asset('vendor/frontend/template/images/section-image-2.png') }}" alt="slidebg1" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                        ...
                        <li data-transition="fade" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="300" data-saveperformance="off" data-title="Slide Title">
                            ...
                            <!-- main image -->
                            <img src="{{ asset('vendor/frontend/template/images/section-image-3.png') }}" alt="slidebg1" data-bgposition="center center" data-bgfit="contain" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
        ...
        <section class="pv-40">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h2 class="text-center mt-4">Choose your plan</h2>
                        <div class="separator"></div>
                        <p class="text-center">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iste doloremque, mollitia voluptatibus nobis. Esse ut dolore laboriosam id fugit impedit totam voluptate, itaque praesentium accusantium, laborum eius autem, veritatis labore!</p>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-lg-center">
                            <div class="col-lg-6">
                                <div class="footer-content text-center padding-ver-clear">
                                    <div class="logo-footer"><img id="logo-footer" class="mx-auto" src="{{ asset('vendor/frontend/template/images/logo_brown.png') }}" alt=""></div>
