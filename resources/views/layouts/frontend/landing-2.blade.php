...
<body class="gradient-background-header transparent-header front-page page-loader-1">
    ...
    <div class="page-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            ...
                                                                            <ul class="menu">
                                                                                ...
                                                                                <li class="active"><a href="index-landing-2.html"><i class="fa fa-star pr-2"></i>Landing Page 2 <span class="badge">v1.3</span></a></li>
                    ...
                    <div id="slider-banner-fullscreen-hero" class="slider-banner-fullscreen-hero rev_slider" data-version="5.0">
                        <ul class="slides">
                            ...
                            <li class="text-center" data-transition="crossfade" data-slotamount="default" data-masterspeed="default" data-title="Slide Title">
                                ...
                                ><img data-ww="600px" data-hh="451px" src="{{ asset('vendor/frontend/template/images/section-image-1.png') }}" alt="">
                                </div>
                                ...
                                <div class="tp-caption large_white hidden-sm-down"
                                     ...
                                     data-transform_in="y:[100%];opacity:0;s:1100;"
                                     data-transform_out="y:[100%];opacity:0;s:800;"
                                ><img data-ww="600px" data-hh="451px" src="{{ asset('vendor/frontend/template/images/section-image-2.png') }}" alt="">
                                </div>
                                ...
                                ><img data-ww="600px" data-hh="451px" src="{{ asset('vendor/frontend/template/images/section-image-4.png') }}" alt="">
                                </div>
        ...
        <!-- section start -->
        <!-- ================ -->
        <section class="clearfix text-center pv-30 hc-element-invisible" data-animation-effect="zoomIn" data-effect-delay="300">
            <div class="container">
                <div class="row justify-content-lg-center">
                    <div class="col-lg-8">
                        <h1 class="text-center mt-4">The Project</h1>
        ...
        <section class="full-width-section hover-disabled space-bottom">
            <div class="full-image-container ph-40 hc-element-invisible" data-animation-effect="fadeInLeft" data-effect-delay="300">
                <img class="to-right-block" src="{{ asset('vendor/frontend/template/images/section-image-2.png') }}" alt="">
            </div>
            <div class="full-text-container white-bg ">
                <h2 class="mt-4">Feature One</h2>
                ...
                <a href="#" class="btn btn-default">Read More <i class="pl-10 fa fa-angle-right"></i></a>
            </div>
        </section>
        <!-- section end -->
        ...
        <section class="full-width-section light-gray-bg hover-disabled">
            <div class="full-text-container light-gray-bg left text-right">
                <h2 class="mt-4">Feature Two</h2>
                <div class="separator-3 hidden-lg-down"></div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi veniam, veritatis sint consequuntur! Natus, culpa, explicabo! Non quo laboriosam nobis quia, amet excepturi optio dolor impedit. Perferendis libero unde, nulla deserunt sequi. Voluptatum, officia suscipit porro reprehenderit vitae quo rem reiciendis, a vero quae. Vero beatae voluptatum.</p>
                <div class="separator-2 hidden-lg-down"></div>
                <a href="#" class="btn btn-default">Read More <i class="pl-10 fa fa-angle-right"></i></a>
            </div>
            <div class="full-image-container ph-40 hc-element-invisible" data-animation-effect="fadeInRight" data-effect-delay="300">
                <img src="{{ asset('vendor/frontend/template/images/section-image-4.png') }}" alt="">
            </div>
        </section>
        <!-- section end -->
        ...
        <section class="full-width-section hover-disabled space-top">
            <div class="full-image-container ph-40 hc-element-invisible space-bottom" data-animation-effect="fadeInLeft" data-effect-delay="300">
                <img class="to-right-block" src="{{ asset('vendor/frontend/template/images/section-image-1.png') }}" alt="">
            </div>
            <div class="full-text-container white-bg">
                <h2 class="mt-4">Feature Three</h2>
                <div class="separator-2 hidden-lg-down"></div>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi veniam, veritatis sint consequuntur! Natus, culpa, explicabo! Non quo laboriosam nobis quia, amet excepturi optio dolor impedit. Perferendis libero unde, nulla deserunt sequi. Voluptatum, officia suscipit porro reprehenderit vitae quo rem reiciendis, a vero quae. Vero beatae voluptatum.</p>
                <div class="separator-3 hidden-lg-down"></div>
                <a href="#" class="btn btn-default">Read More <i class="pl-10 fa fa-angle-right"></i></a>
        ...
        <section class="dark-bg pv-40">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="pv-30 ph-20 hc-item-box bordered text-center hc-element-invisible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
                    ...
                    <div class="col-lg-4">
                        <div class="pv-30 ph-20 hc-item-box text-center hc-element-invisible" data-animation-effect="fadeInDownSmall" data-effect-delay="100">
                            <span class="icon default-bg"><i class="fa fa-snowflake-o"></i></span>
        ...
        <section class="pv-40">
            <div class="container">
                <h1 class="large text-center mt-4">Choose your <strong>Plan</strong></h1>
                ...
                <!-- ================ -->
                <div class="pricing-tables stripped hc-element-invisible" data-animation-effect="fadeInUpSmall"  data-effect-delay="0">
                    <div class="row grid-space-0">
                        ...
                        <div class="col-md-3 plan stripped">
                            ...
                            <ul>
                                ...
                                <li>Pricing table item</li>
                                <li>Pricing table item</li>
                                <li><a href="#" class="btn btn-default-transparent btn-animated">Subscribe <i class="fa fa-user"></i></a></li>
                            </ul>
                        </div>
                        <!-- pricing table end -->
                        ...
                        <div class="col-md-3 plan stripped">
                            ...
                            <ul>
                                ...
                                <li>Pricing table item</li>
                                <li>Pricing table item</li>
                                <li><a href="#" class="btn btn-default-transparent btn-animated">Add to cart <i class="fa fa-shopping-cart"></i></a></li>
                            </ul>
                        </div>
                        <!-- pricing table end -->
        ...
        <!-- section start -->
        <!-- ================ -->
        <section class="dark-translucent-bg fixed-bg pv-40" style="background: url('{{ asset('vendor/frontend/template/images/landing-background-img-1.jpg') }}') 50% 50% no-repeat;">
            <div class="container">
                <div class="row justify-content-lg-center">
                    <div class="col-lg-8">
