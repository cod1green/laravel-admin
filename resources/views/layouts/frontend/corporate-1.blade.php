...
<body class="front-page ">
    ...
    <div class="page-wrapper">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-3">
                                                                            ...
                                                                            <ul class="menu">
                                                                                ...
                                                                                <li class="active"><a href="index-corporate-1.html"><i class="fa fa-suitcase pr-2"></i>Corporate 1</a></li>
                    ...
                    <div id="slider-banner-fullwidth" class="slider-banner-fullwidth rev_slider" data-version="5.0">
                        <ul class="slides">
                            ...
                            <li data-transition="crossfade" data-slotamount="default" data-masterspeed="default" data-title="Next Generation Template">
                                ...
                                <!-- main image -->
                                <img src="{{ asset('vendor/frontend/template/images/corporate-1-slider-slide-1.jpg') }}" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover"  class="rev-slidebg">
                            ...
                            <li class="text-center" data-transition="fade" data-slotamount="default" data-masterspeed="default" data-title="Premium Bootstrap Template">
                                ...
                                <!-- main image -->
                                <img src="{{ asset('vendor/frontend/template/images/corporate-1-slider-slide-2.jpg') }}" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="call-to-action">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h3 class="mt-10 text-muted">Adipisci blanditiis placeat suscipit itaque obcaeca</h3>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 order-lg-2">
                        <div class="overlay-container overlay-visible">
                            <img src="{{ asset('vendor/frontend/template/images/section-image-4.jpg') }}" alt="">
        ...
        <!-- section start -->
        <!-- ================ -->
        <section class="dark-translucent-bg pv-30" style="background-image:url({{ asset('vendor/frontend/template/images/page-services-banner.jpg') }});">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="pv-30 hc-item-box text-center hc-element-invisible" data-animation-effect="fadeInDownSmall" data-effect-delay="200">
                    ...
                    <div class="col-lg-4">
                        <div class="pv-30 hc-item-box text-center hc-element-invisible" data-animation-effect="fadeInDownSmall" data-effect-delay="300">
        ...
        <section class="light-gray-bg pv-40">
            <div class="container">
                <h3 class="mt-4"><span class="logo-font text-muted">The <span class="text-default">Project</span></span> is Simply Amazing</h3>
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="progress style-1">
                            ...
                            <div class="progress-bar progress-bar-default" data-animate-width="75%">
                                <span class="label hc-element-invisible" data-animation-effect="fadeInLeftSmall" data-effect-delay="1000">PHOTOSHOP</span>
                            </div>
                        </div>
                        <div class="progress style-1">
                            <span class="text"></span>
