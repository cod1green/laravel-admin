                    ...
                    <div class="col-3 col-sm-6 col-lg-9">
                        ...
                        <div class="header-top-first clearfix">
                            <ul class="social-links circle small clearfix hidden-sm-down">
                                <li class="flickr"><a href="https://www.instagram.com/muaythaicotia" target="_blank"><i
                                            class="fa fa-instagram"></i></a></li>
                                <li class="facebook"><a href="https://www.facebook.com/muaythaicotia" target="_blank"><i
                                            class="fa fa-facebook"></i></a></li>
                                <li class="xing"><a
                                        href="https://api.whatsapp.com/send?phone=5511969339297&text=Ol%C3%A1%2C%20gostaria%20de%20receber%20mais%20informa%C3%A7%C3%B5es%20sobre%20as%20aulas."
                            ...
                            <div class="social-links hidden-md-up circle small">
                                <div class="btn-group dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-animation" aria-labelledby="header-top-drop-1">
                                        <li class="flickr"><a href="https://www.instagram.com/muaythaicotia"
                                                              target="_blank"><i class="fa fa-instagram"></i></a></li>
                                        <li class="facebook"><a href="https://www.facebook.com/muaythaicotia"
                            ...
                            <ul class="list-inline hidden-md-down">
                                ...
                                <li class="list-inline-item"><i class="fa fa-phone pr-1 pl-2"></i>(11) 96933-9297</li>
                    ...
                    <div class="col-md-auto hidden-md-down d-flex align-items-center">
                        ...
                        <div class="header-first clearfix py-lg-1">
                            ...
                            <div id="logo" class="logo">
                                <a href="{{ route('index') }}">
                                    <img id="logo_img" width="70" src="{{ asset('img/muaythai/logo_100x100.png')  }}"
                                         alt="">
                                </a>
                            </div>
                                        ...
                                        <div id="logo-mobile" class="logo">
                                            <a href="{{ route('index') }}">
                                                <img id="logo-img-mobile" width="70"
                                                     src="{{ asset('img/muaythai/logo_100x100.png')  }}"
                                                     alt="The Project">
                                            </a>
                                        </div>
                        ...
                        <div class="col-lg-3">
                            <div class="footer-content pt-0">
                                ...
                                <p>O nosso objetivo sempre é proporcionar qualidade de vida para nossos alunos através
                                    ...
                                    time de profissionais. As artes marciais e os esportes de contato são uma terapia
                                    para
