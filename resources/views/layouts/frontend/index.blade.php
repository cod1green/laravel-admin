                    ...
                    <div class="col-md-auto hidden-md-down">
                        ...
                        <div class="header-first clearfix">
                            ...
                            <div id="logo" class="logo">
                                <a href="index.html"><img id="logo_img" src="{{ asset('vendor/frontend/template/images/logo_vivid_red.png') }}" alt="The Project"></a>
                            </div>
                                ...
                                <nav class="navbar navbar-expand-lg navbar-light p-0">
                                    <div class="navbar-brand clearfix hidden-lg-up">
                                        ...
                                        <div id="logo-mobile" class="logo">
                                            <a href="index.html"><img id="logo-img-mobile" src="{{ asset('vendor/frontend/template/images/logo_vivid_red.png') }}" alt="The Project"></a>
                                        </div>
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="third-dropdown">
                                                    ...
                                                    <li class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            <li><a target="_blank" href="email_templates/email_template_vivid_red.html">Light Blue</a></li>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="footer-content">
                                <div class="logo-footer"><img id="logo-footer" src="{{ asset('vendor/frontend/template/images/logo_vivid_red.png') }}" alt=""></div>
