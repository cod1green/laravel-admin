...
<body class="transparent-header gradient-background-header front-page ">
    ...
    <div class="page-wrapper">
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                                        ...
                                        <div class="collapse navbar-collapse scrollspy" id="navbar-collapse-1">
                                            ...
                                            <ul class="navbar-nav ml-lg-auto">
                                                <li class="nav-item"><a class="nav-link smooth-scroll active" href="#slider-banner-fullscreen">Home</a></li>
                                                <li class="nav-item"><a class="nav-link smooth-scroll" href="#section-2">About</a></li>
                                                <li class="nav-item"><a class="nav-link smooth-scroll" href="#section-3">Portfolio</a></li>
                                                <li class="nav-item"><a class="nav-link smooth-scroll" href="#section-4">Testimonials</a></li>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="fullscreen-slide">
                            <div class="background-image" style="background-image:url('{{ asset('vendor/frontend/template/images/agency-background-img-1.jpg') }}');"></div>
                            <div class="background-image-overlay"></div>
                            <div class="container">
                                <div class="hc-slideshow-caption p-3 w-100">
                                    <div class="row">
                                        <div class="col-md-8">
                                            <h1 class="title large text-white animated fadeInDown hc-animation-delay-1000">Wellcome to <span class="text-default">The Agency</span></h1>
                                            <div class="separator-2 animated fadeInUp hc-animation-delay-1250"></div>
                                            <p class="large animated fadeInLeft hc-animation-delay-1500">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Excepturi perferendis magnam ea necessitatibus, officiis voluptas odit! Aperiam omnis, cupiditate laudantium velit nostrum, exercitationem accusamus, possimus soluta illo deserunt tempora qui.</p>
                                            <a href="#" class="btn btn-default btn-xl animated fadeInLeft hc-animation-delay-1750">Let's Start</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <section id="section-2" class="section light-gray-bg">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="hc-item-box-2">
                            ...
                            <div class="body">
                                ...
                                <a class="link-light" href="page-services.html">Read More<i class="pl-1 fa fa-angle-double-right"></i></a>
                            </div>
                            <div class="space-bottom"></div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hc-item-box-2">
                            <span class="default-bg icon small"><i class="fa fa fa-snowflake-o"></i></span>
                            <div class="body">
                                <h4 class="title">We Use Lorem dolor sit</h4>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hc-item-box-2">
                            ...
                            <div class="body">
                                <h4 class="title">We Are Porro ullam volu</h4>
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="hc-item-box-2">
                            <span class="default-bg icon small"><i class="fa fa fa-life-ring"></i></span>
                            <div class="body">
                                <h4 class="title">Unt lorem culpa qui</h4>
        ...
        <!-- section start -->
        <!-- ================ -->
        <section id="section-3" class="section light-gray-bg border-bottom-0">
            <div class="container">
                <div class="row justify-content-lg-center">
                    <div class="col-lg-8 text-center">
                        <h2 class="title mt-4">Recent <span class="text-default">Projects</span></h2>
        ...
        <section id="section-4" class="section light-gray-bg border-top-0">
