...
<head>
    ...
    <link href="{{ asset('vendor/frontend/template/css/skins/blue.css') }}" rel="stylesheet">
                        ...
                        <div class="col-md-auto hidden-md-down pl-3">
                            ...
                            <div class="header-first clearfix">
                                ...
                                <div id="logo" class="logo">
                                    <a href="index.html"><img id="logo_img" src="{{ asset('vendor/frontend/template/images/logo_blue.png') }}" alt="The Project"></a>
                                </div>
                                    ...
                                    <nav class="navbar navbar-expand-lg navbar-light p-0">
                                        <div class="navbar-brand clearfix hidden-lg-up">
                                            ...
                                            <div id="logo-mobile" class="logo">
                                                <a href="index.html"><img id="logo-img-mobile" src="{{ asset('vendor/frontend/template/images/logo_blue.png') }}" alt="The Project"></a>
                                            </div>
                    ...
                    <div id="slider-banner-fullwidth-big-height" class="slider-banner-fullwidth-big-height rev_slider" data-version="5.0">
                        <ul class="slides">
                            ...
                            <li data-transition="fadefromright" data-slotamount="default" data-masterspeed="default" data-title="We Can Build Anything">
                                ...
                                <!-- main image -->
                                <img src="{{ asset('vendor/frontend/template/images/construction-slider-slide-1.jpg') }}" alt="slidebg1" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover"  class="rev-slidebg">
                            ...
                            <li data-transition="fadefromright" data-slotamount="default" data-masterspeed="default" data-title="Make your Dreams Come True">
                                ...
                                <!-- main image -->
                                <img src="{{ asset('vendor/frontend/template/images/construction-slider-slide-2.jpg') }}" alt="slidebg2" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
                            ...
                            <div class="col-lg-6">
                                <div class="slick-carousel content-slider-with-controls">
                                    <div class="overlay-container overlay-visible">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-1.jpg') }}" alt="">
                                        <div class="overlay-bottom hidden-sm-down">
                                            <div class="text">
                                                <h3 class="title">We Create You Enjoy</h3>
                                            </div>
                                        </div>
                                        <a href="images/construction-1.jpg" class="slick-carousel--popup-img overlay-link" title="image title"><i class="fa fa-plus"></i></a>
                                    </div>
                                    <div class="overlay-container overlay-visible">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-2.jpg') }}" alt="">
                                        <div class="overlay-bottom hidden-sm-down">
                                            <div class="text">
                                                <h3 class="title">You Can Trust Us</h3>
                                            </div>
                                        </div>
                                        <a href="images/construction-2.jpg" class="slick-carousel--popup-img overlay-link" title="image title"><i class="fa fa-plus"></i></a>
                                    </div>
                                    <div class="overlay-container overlay-visible">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-3.jpg') }}" alt="">
                                        <div class="overlay-bottom hidden-sm-down">
                                            <div class="text">
                                                <h3 class="title">We Love What We Do</h3>
                                            </div>
                                        </div>
                                        <a href="images/construction-3.jpg" class="slick-carousel--popup-img overlay-link" title="image title"><i class="fa fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="image-box style-2 mb-20">
                            <div class="overlay-container overlay-visible">
                                <img src="{{ asset('vendor/frontend/template/images/construction-service-1.jpg') }}" alt="">
                    ...
                    <div class="col-md-4">
                        <div class="image-box style-2 mb-20">
                            <div class="overlay-container overlay-visible">
                                <img src="{{ asset('vendor/frontend/template/images/construction-service-2.jpg') }}" alt="">
                                <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                                <div class="overlay-bottom">
                                    <div class="text">
                    ...
                    <div class="col-md-4">
                        <div class="image-box style-2 mb-20">
                            <div class="overlay-container overlay-visible">
                                <img src="{{ asset('vendor/frontend/template/images/construction-service-3.jpg') }}" alt="">
                                <a href="#" class="overlay-link"><i class="fa fa-link"></i></a>
                                <div class="overlay-bottom">
                                    <div class="text">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 padding-bottom-clear pv-30">
                        <div class="hc-item-box-2 hc-element-invisible" data-animation-effect="fadeInDownSmall" data-effect-delay="200">
                            <span class="icon without-bg"><i class="fa fa-check"></i></span>
                            <div class="body">
                    ...
                    <div class="col-12">
                        ...
                        <div class="isotope-container row grid-space-10">
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <div class="image-box hc-shadow bordered text-center mb-20">
                                                <div class="overlay-container">
                                                    <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-1.jpg') }}" alt="">
                                        ...
                                        <div class="carousel-item">
                                            <div class="image-box hc-shadow bordered text-center mb-20">
                                                <div class="overlay-container">
                                                    <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-1-2.jpg') }}" alt="">
                                                    <div class="overlay-top">
                                                        <div class="text">
                                                            <h3><a href="portfolio-item.html">Project Title</a></h3>
                                                        </div>
                                        ...
                                        <div class="carousel-item">
                                            <div class="image-box hc-shadow bordered text-center mb-20">
                                                <div class="overlay-container">
                                                    <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-1-3.jpg') }}" alt="">
                                                    <div class="overlay-top">
                                                        <div class="text">
                                                            <h3><a href="portfolio-item.html">Project Title</a></h3>
                                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 isotope-item construction-management">
                                <div class="image-box hc-shadow bordered text-center mb-20">
                                    <div class="overlay-container">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-2.jpg') }}" alt="">
                                        <div class="overlay-top">
                                            <div class="text">
                                                <h3><a href="portfolio-item.html">Project Title</a></h3>
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 isotope-item construction-management">
                                <div class="image-box hc-shadow bordered text-center mb-20">
                                    <div class="overlay-container">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-3.jpg') }}" alt="">
                                        <div class="overlay-top">
                                            <div class="text">
                                                <h3><a href="portfolio-item.html">Project Title</a></h3>
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 isotope-item interior-design">
                                <div class="image-box hc-shadow bordered text-center mb-20">
                                    <div class="overlay-container">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-4.jpg') }}" alt="">
                                        <div class="overlay-top">
                                            <div class="text">
                                                <h3><a href="portfolio-item.html">Project Title</a></h3>
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 isotope-item architecture-plans">
                                <div class="image-box hc-shadow bordered text-center mb-20">
                                    <div class="overlay-container">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-5.jpg') }}" alt="">
                                        <div class="overlay-top">
                                            <div class="text">
                                                <h3><a href="portfolio-item.html">Project Title</a></h3>
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 isotope-item construction-management">
                                <div class="image-box hc-shadow bordered text-center mb-20">
                                    <div class="overlay-container">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-6.jpg') }}" alt="">
                                        <div class="overlay-top">
                                            <div class="text">
                                                <h3><a href="portfolio-item.html">Project Title</a></h3>
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 isotope-item architecture-plans">
                                <div class="image-box hc-shadow bordered text-center mb-20">
                                    <div class="overlay-container">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-7.jpg') }}" alt="">
                                        <div class="overlay-top">
                                            <div class="text">
                                                <h3><a href="portfolio-item.html">Project Title</a></h3>
                                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 isotope-item interior-design">
                                <div class="image-box hc-shadow bordered text-center mb-20">
                                    <div class="overlay-container">
                                        <img src="{{ asset('vendor/frontend/template/images/construction-portfolio-8.jpg') }}" alt="">
                                        <div class="overlay-top">
                                            <div class="text">
                                                <h3><a href="portfolio-item.html">Project Title</a></h3>
                                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="nav nav-tabs style-3" role="tablist">
                            ...
                            <li class="nav-item"><a class="nav-link" href="#h3tab2" role="tab" data-toggle="tab"><i class="fa fa-user pr-10"></i>Unt lorem culpa quilor</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="footer-content">
                                    <div class="logo-footer"><img id="logo-footer" src="{{ asset('vendor/frontend/template/images/logo_blue.png') }}" alt=""></div>
