                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ route('admin.config.optimize.cache') }}" class="nav-link">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.config.optimize.clear') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Todos limpar</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.config.route.cache') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Rotas cache</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.config.route.clear') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Rotas limpar</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.config.view.cache') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Visão cache</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.config.view.clear') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Visão limpar</p>
                                    </a>
                                </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.config.config.cache') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.config.config.clear') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.config.cache.clear') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Caches limpar</p>
                                    </a>
                                </li>
