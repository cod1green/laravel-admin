...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1><i class='fa fa-briefcase'></i> @lang('admin.roles.edit')</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"><i class='fa fa-briefcase'></i> @lang('admin.roles.edit')</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card card-success">
                    ...
                    <div class="card-body">
                        {{-- Form model para preencher automaticamente os campos com dados da função --}}
                        {{ Form::model($role, array('route' => array('admin.roles.update', $role->id), 'method' => 'PUT')) }}
                            <div class="form-group">
                                {{ Form::label('name', trans('admin.name')) }} {{ Form::text('name', null, array('class' => 'form-control')) }}
                            </div>
