...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class='fa fa-user-tag'></i> @lang('admin.permissions.edit')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><i
                                class='fa fa-user-tag'></i> @lang('admin.permissions.edit')</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            @if(!$roles->isEmpty())
                                ...
                                @foreach ($roles as $role)
                                    {{ Form::checkbox('roles[]', $role->id ) }} {{ Form::label($role->name, ucfirst($role->name)) }}
                                    <br>
                                @endforeach
                            @endif
