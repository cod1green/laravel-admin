                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                @if(Auth::user()->avatar)
                                    <img class="profile-user-img img-fluid img-circle" src="{{ Auth::user()->avatar->getUrl('thumb') }}" style="width: 88px;height: 88px;">
                                @else
                                    <img class="profile-user-img img-fluid img-circle" src="{{ asset('img/no-user.png') }}" style="width: 88px;height: 88px;">
                                @endif
                            </div>
