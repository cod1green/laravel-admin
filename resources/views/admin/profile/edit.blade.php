                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            ...
                            <img class="profile-user-img img-fluid img-circle"
                                src="{{ Auth::user()->avatar->getUrl('thumb') }}" style="width: 88px;height: 88px;">
                            @else
                            <img class="profile-user-img img-fluid img-circle" src="{{ asset('img/no-user.png') }}"
                ...
                <div class="card">
                    ...
                    <form role="form" action="{{ route('profile.update') }}" method="POST"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="password">@lang('admin.password_confirmation')</label>
